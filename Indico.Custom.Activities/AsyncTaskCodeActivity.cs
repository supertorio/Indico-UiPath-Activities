...
{
	/// <summary>
	///     Indico.Custom AsyncTaskCodeActivity with result <T>
	/// </summary>
	public abstract class AsyncTaskCodeActivity<T> : AsyncCodeActivity, IDisposable
	{
		...
		protected override IAsyncResult BeginExecute(AsyncCodeActivityContext context, AsyncCallback callback, object state)
		{
			...
			var property = context.DataContext.GetProperties()[IndicoCustomScope.ParentContainerPropertyTag];
	...
	/// <summary>
	///     Indico.Custom AsyncTaskCodeActivity without result
	/// </summary>
